...
export default function AboutModal({ triggerText = "Tentang Pustaka Pangkalan", className = "" }: { triggerText?: string; className?: string }) {
  ...
  const modalContent = isOpen && mounted ? (
    ...
    >
      <div 
        className="relative w-full max-w-lg bg-surface-container text-on-surface border border-outline-variant/30 rounded-3xl p-6 sm:p-8 shadow-2xl animate-fade-in-up my-auto"
