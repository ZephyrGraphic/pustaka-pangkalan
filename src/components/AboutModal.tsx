    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-fade-in">
          <div 
            className="relative w-full max-w-lg min-w-[300px] sm:min-w-[400px] bg-surface-container border border-outline-variant/30 rounded-3xl p-6 sm:p-8 shadow-2xl animate-fade-in-up my-auto"
