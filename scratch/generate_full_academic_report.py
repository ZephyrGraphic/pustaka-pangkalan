# -*- coding: utf-8 -*-
"""
Full Academic Report Generator for Pustaka Pangkalan
Generates comprehensive 7-chapter thesis-grade official report in Markdown, LaTeX, DOCX, and PDF.
"""
...
DOCS_DIR = r"D:\CODEX-PROJECT\Perpustakaan Digital\docs"
MD_FILE = os.path.join(DOCS_DIR, "laporan_utuh_pustaka_pangkalan.md")
TEX_FILE = os.path.join(DOCS_DIR, "laporan_utuh_pustaka_pangkalan.tex")
DOCX_FILE = os.path.join(DOCS_DIR, "laporan_utuh_pustaka_pangkalan.docx")
PDF_FILE = os.path.join(DOCS_DIR, "laporan_utuh_pustaka_pangkalan.pdf")

def write_markdown_report():
    print("Membangun naskah lengkap laporan akademis dan resmi...")
...
""")
        ...
        f.write("""# BAB II — LANDASAN TEORI DAN KAJIAN PUSTAKA
...
""")
        ...
        f.write("""# BAB III — METODOLOGI PENELITIAN DAN PENGEMBANGAN
...
""")
        ...
        print("Chapters 1 to 3 written successfully")
        
        # 5. BAB IV: ANALISIS DAN PERANCANGAN SISTEM
        f.write("""# BAB IV — ANALISIS DAN PERANCANGAN SISTEM
...
""")
        ...
        # 6. BAB V: IMPLEMENTASI SISTEM
        f.write("""# BAB V — IMPLEMENTASI SISTEM
...
- Label Beranda $\rightarrow$ *Tepas*
- Label Jelajah Katalog $\rightarrow$ *Kotretan Buku / Papay*
- Label Rak Buku $\rightarrow$ *Rak Buku Abdi*
- Label Profil $\rightarrow$ *Profil Warga*
- Label Baca Sekarang $\rightarrow$ *Maca Ayeuna*
...
""")
        ...
        # 7. BAB VI: PENGUJIAN DAN EVALUASI SISTEM
        f.write("""# BAB VI — PENGUJIAN DAN EVALUASI SISTEM
...
| | | Alih bahasa instan (Indonesia $\rightarrow$ Sunda) | Klik tombol bahasa 'SU' pada bilah atas | Seluruh label antarmuka berubah seketika ke Basa Sunda | Sesuai harapan, lokalisasi dinamis | **PASS** |
...
""")
        ...
        print("Chapter 6 written successfully")
        
        # 8. BAB VII: PENUTUP
        f.write("""# BAB VII — PENUTUP
...
""")
        ...
        print("Chapter 7 written successfully")
        
        # 9. BAGIAN AKHIR: DAFTAR PUSTAKA & LAMPIRAN
        f.write("""# DAFTAR PUSTAKA {.unnumbered}
...
""")
    ...
    print(f"File Markdown sukses dibuat di: {MD_FILE}")
